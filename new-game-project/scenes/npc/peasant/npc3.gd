...
func trigger_dialogue():
	...
	if not has_rewarded:
		...
		GlobalVar.coin_collected += 20
		dialog_text = "Terima kasih sudah Menemukanku Ini 20 koin untukmu."
		has_rewarded = true
	else:
		# Interaksi berikutnya
		dialog_text = "Tolong Selamatkan Raja Obsidian Kingdom, Semoga kamu dapat menyelamatkan Dunia ini"
